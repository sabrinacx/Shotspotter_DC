...
ggplot(data = shp) +
  ...
  labs(title = "Gunfire Incidents in DC between 2006 and 2017",
       ...
       caption = "Source: ShotSpotter Data from the Justice Tech Lab. Thank you for providing the data!" ) +
  
  # added x and y axis labels. ***** THEME GOT RID OF X AND Y AXIS LABELS. 
